...
public class CODM_GUNSMITH2 {

	public static void main(String[] args) {
		
		System.out.println("CALL OF DUTY: MOBILE BOOTLEG CUZTOMIZATION");
		System.out.println(" ");
		
		Scanner codm = new Scanner(System.in);
		
//		String GUNS [] = {" AMAX,", " M16", " DR-H,", " AK47", " STRIKER", " RYTEC AMR,", " NA-45", " AGR"};
//		String SCOPE [] = {"x2", " ,x4", " ,x6", " ,x8"};
//		String CAMO [] = {" GOLD,", " PLATINUM,", " DAMASCUS,", " DIAMOND,", " AETHER,", " OBSIDIAN,"};
//		
//		
//		System.out.println("RYE GUNS:"+(GUNS [0]) +(GUNS [2]) +(GUNS [5]));
//		System.out.println("SCOPE EQUIP: " +(SCOPE [0]) +(SCOPE [2]) +(SCOPE [3]));
//		System.out.println("CAMOS EQUIP: " +(CAMO [1]) +(CAMO [2]) +(CAMO [2]));
//		System.out.println(" ");
//		System.out.println("CHOOSE PRIMARY SOLDIER: ARTERY, EMA, MEGALITH, MAKAROV");
//		String soldier = codm.next();
//		
//		if (soldier.equals("ARTERY") || soldier.equals("artery")) {
//			System.out.println("PRIMARY SOLDIER: ARTERY");
//		}
//		
//		else if (soldier.equals("EMA") || soldier.equals("ema")) {
//			System.out.println("PRIMARY SOLDIER: EMA");
//		}
//		
//		else if (soldier.equals("MEGALITH") || soldier.equals("megalith")) {
//			System.out.println("PRIMARY SOLDIER: MEGALITH");
//		}
//		else if (soldier.equals("MAKAROV") || soldier.equals("makarov")) {
//			System.out.println("PRIMARY SOLDIER: MAKAROV");
//			
//	} 	else {
//		System.out.println("INVALID SOLDIER");   
//	}
//		System.out.println("CHOOSE ROUND AMMO: 30 | 60 | 90 | 120 | 150 | 200 ");
//		
//		int bullet = codm.nextInt();
//		
//		if (bullet == 30) {
//			System.out.println("YOUR AMMO IS \"30\"");
//		}
//		else if (bullet == 60) {
//			System.out.println("YOUR AMMO IS \"60\"");
//		}
//		else if (bullet == 90) {
//			System.out.println("YOUR AMMO IS \"90\"");
//		}
//		else if (bullet == 120) {
//			System.out.println("YOUR AMMO IS \"120\"");
//		}
//		else if (bullet == 150) {
//			System.out.println("YOUR AMMO IS \"150\"");
//		}
//		else if (bullet == 200) {
//			System.out.println("YOUR AMMO IS \"200\"");
//		}
//		else {
//			System.out.println("INVALID AMMO!");
//		}
